...
const TOOLS = [
  ...
  },
  {
    id: "html-to-jsx",
    title: "HTML ↔ JSX 変換",
    description: "HTMLをReact用JSXに変換します。class→className、for→htmlFor、onclick→onClick、style文字列→オブジェクトなどを自動変換。",
    category: "convert",
    href: "/html-to-jsx",
    ready: true,
  },
  {
    id: "sql-formatter",
    title: "SQLフォーマッター",
    description: "SQLをキーワード大文字化・インデント整形・圧縮できます。SELECT/FROM/WHERE/JOIN等の主要句を自動改行。",
    category: "format",
    href: "/sql-formatter",
    ready: true,
  },
  {
    id: "contrast-checker",
    title: "コントラスト比チェッカー",
    description: "テキスト色と背景色のコントラスト比を計算し、WCAG 2.1のAA・AAAレベルを満たすか判定します。カラーピッカー付き。",
    category: "calc",
  ...
  },
  {
    id: "csv-json",
    title: "CSV ↔ JSON 変換",
    description: "CSVとJSONを双方向に変換。CSVヘッダーをキーとしたJSONオブジェクト配列に変換し、テーブルプレビューを表示します。",
    category: "convert",
    href: "/csv-json",
    ready: true,
  },
  {
    ...
    description: "JSONオブジェクトからTypeScriptのinterface・type定義を自動生成します。型名指定・interface/type切替対応。",
    category: "convert",
    href: "/json-to-ts",
    ready: true,
  },
  {
    ...
    description: "Conventional Commits形式のコミットメッセージをGUIで作成。feat/fix/docs等11種のタイプ、スコープ、BREAKING CHANGE対応。",
    category: "generate",
  ...
  },
  {
    ...
    title: ".gitignore生成",
    description: "Node.js/Python/Java/React/Go/Rust/Terraform/Unityなど8テンプレートから選択して.gitignoreを生成。ダウンロードボタン付き。",
    category: "generate",
  ...
  },
  {
    id: "qr-generator",
    title: "QRコード生成",
    description: "テキスト・URLからQRコードを生成。SVG・PNG形式でダウンロード可能。サイズ200/300/400px選択対応。",
    category: "generate",
    href: "/qr-generator",
    ready: true,
  },
  {
    ...
    description: "curlコマンドをFetch API・Axios・Python requestsのコードに変換。-X/-H/-d/-uオプション対応。サンプル付き。",
    category: "convert",
    href: "/curl-to-fetch",
    ready: true,
  },
